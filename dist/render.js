...
const renderElement = (element, stylesheets, renderers, children, index, classNameRender) => {
    if (typeof element === 'string') {
    ...
    let elementStyles = [];
    if (classNameRender) {
        elementStyles.push(classNameRender === null || classNameRender === void 0 ? void 0 : classNameRender(element.classNames));
    }
    elementStyles.push(...element.style);
    return (react_1.default.createElement(Element, { key: index, style: elementStyles, children: children, element: element, stylesheets: stylesheets }));
};
...
const renderBucketElement = (element, options, index) => {
    if (typeof element === 'string') {
        return (0, exports.renderElement)(options.collapse ? (0, exports.collapseWhitespace)(element) : element, options.stylesheets, options.renderers, undefined, index, options.classNameRenderer);
    }
    return (0, exports.renderElement)(element, options.stylesheets, options.renderers, (0, exports.renderElements)(element.content, element.tag === 'pre' ? Object.assign(Object.assign({}, options), { collapse: false }) : options, element), index, options.classNameRenderer);
};
...
const renderHtml = (text, options = {}) => {
    ...
    return (react_1.default.createElement(renderer_1.View, { style: [...styles, fontSizeStyle] }, (0, exports.renderElements)(parsed.rootElement.content, opts)));
};
