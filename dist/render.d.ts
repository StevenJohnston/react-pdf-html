...
export declare const renderElement: (element: HtmlElement | string, stylesheets: HtmlStyles[], renderers: HtmlRenderers, children?: any, index?: number | undefined, classNameRender?: ClassNameRenderer | undefined) => RenderedContent;
